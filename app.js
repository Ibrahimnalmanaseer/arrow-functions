...
let Student = function(name, age, hometown) {
  ...
  let trt = new Student('troon', 100, 'Anytown, USA');
  ...
  // 3. Explain why "this" is different when an arrow function is used.
      ...
      //  as 'this' is not reset in arrow functions,so arrow function will reatin 'this' value in the global browser 
      //  incase it is not inside a normal function.